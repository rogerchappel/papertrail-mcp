# Agent Operating Instructions for papertrail-mcp

This file defines how AI agents and human maintainers should work in `papertrail-mcp`.

## Project Context

- Project: `papertrail-mcp`
- Repository: ``
- Primary maintainer: ``
- Default branch: ``
- Package manager: ``
